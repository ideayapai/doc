...
{
    public abstract class RepositoryContext : DataContext
    {
        ...
        public RepositoryContext(string connectionString, MappingSource mappingSource)
            : base(connectionString, mappingSource)
        {
        }

        public RepositoryContext(IDbConnection connection, MappingSource mappingSource)
